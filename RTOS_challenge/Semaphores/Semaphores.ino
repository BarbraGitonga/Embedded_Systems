...
static SemaphoreHandle_t filled_slots = NULL;
static SemaphoreHandle_t empty_slots = NULL;
...
void setup() {
  ...
  filled_slots = xSemaphoreCreateCounting(BUF_SIZE, BUF_SIZE);
  empty_slots = xSemaphoreCreateCounting(BUF_SIZE, 0);
