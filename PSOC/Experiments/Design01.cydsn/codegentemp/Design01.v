...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("ba44cd90-5b56-465a-a09c-bd18bf2caad0/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__LDR_IN_net;
	wire [0:0] tmpFB_0__LDR_IN_net;
	wire [0:0] tmpIO_0__LDR_IN_net;
	wire [0:0] tmpINTERRUPT_0__LDR_IN_net;
	electrical [0:0] tmpSIOVREF__LDR_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		LDR_IN
		 (.oe(tmpOE__LDR_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LDR_IN_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__LDR_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__LDR_IN_net),
		  .interrupt({tmpINTERRUPT_0__LDR_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LDR_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
