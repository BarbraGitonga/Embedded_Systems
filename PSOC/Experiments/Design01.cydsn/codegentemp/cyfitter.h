...
/* LDR_IN */
#define LDR_IN__0__INTTYPE CYREG_PICU1_INTTYPE6
#define LDR_IN__0__MASK 0x40u
#define LDR_IN__0__PC CYREG_PRT1_PC6
#define LDR_IN__0__PORT 1u
#define LDR_IN__0__SHIFT 6u
#define LDR_IN__AG CYREG_PRT1_AG
#define LDR_IN__AMUX CYREG_PRT1_AMUX
#define LDR_IN__BIE CYREG_PRT1_BIE
#define LDR_IN__BIT_MASK CYREG_PRT1_BIT_MASK
#define LDR_IN__BYP CYREG_PRT1_BYP
#define LDR_IN__CTL CYREG_PRT1_CTL
#define LDR_IN__DM0 CYREG_PRT1_DM0
#define LDR_IN__DM1 CYREG_PRT1_DM1
#define LDR_IN__DM2 CYREG_PRT1_DM2
#define LDR_IN__DR CYREG_PRT1_DR
#define LDR_IN__INP_DIS CYREG_PRT1_INP_DIS
#define LDR_IN__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define LDR_IN__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define LDR_IN__LCD_EN CYREG_PRT1_LCD_EN
#define LDR_IN__MASK 0x40u
#define LDR_IN__PORT 1u
#define LDR_IN__PRT CYREG_PRT1_PRT
#define LDR_IN__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define LDR_IN__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define LDR_IN__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define LDR_IN__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define LDR_IN__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define LDR_IN__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define LDR_IN__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define LDR_IN__PS CYREG_PRT1_PS
#define LDR_IN__SHIFT 6u
#define LDR_IN__SLW CYREG_PRT1_SLW
